...
export async function getCommunityFeed({
  ...
  const chronologicalItems: CommunityFeedItem[] = [
    ...
    ...prompts.map((item): CommunityFeedItem => ({
      ...
      href: `/catalog/prompts?q=${encodeURIComponent(item.titleRu || item.title)}`,
      createdAt: item.createdAt.toISOString(),
    ...
    ...skills.map((item): CommunityFeedItem => ({
      ...
      href: `/catalog/skills?q=${encodeURIComponent(item.name)}`,
      createdAt: item.createdAt.toISOString(),
      author: item.author,
      coverImages: item.coverImages,
    ...
    ...repos.map((item): CommunityFeedItem => ({
      ...
      href: `/catalog/repos?q=${encodeURIComponent(item.name)}`,
      createdAt: item.createdAt.toISOString(),
      author: item.owner,
      coverImages: item.coverImages,
