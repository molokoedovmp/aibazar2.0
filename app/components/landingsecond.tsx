...
import PaymentInstructionSection from '@/app/components/home/payment-instructions/page';
    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-black text-black dark:text-white font-sans">
      <main className="flex-1">
        ...
        <section className="relative py-12 bg-gray-50 dark:bg-black">
          ...
          <div className="relative z-10 container px-4 md:px-6 flex justify-center items-center">
