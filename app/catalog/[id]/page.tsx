                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {recommendedArticles.map((article) => (
                    <Link
                      ...
                      className="group overflow-hidden rounded-xl border border-black/10 bg-white transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/10 dark:bg-zinc-950"
                    >
                      <ToolImage
            ...
            <div className="rounded-xl border border-black/10 dark:border-white/10 p-5 shadow-sm">
              ...
              {similarTools.length > 0 ? (
                <div className="space-y-3">
                  {similarTools.map((t) => (
                    <Link key={t.id} href={`/catalog/${t.id}`} className="group flex items-center gap-3">
                      <ToolImage
                        src={t.coverImage}
                        alt={t.name}
